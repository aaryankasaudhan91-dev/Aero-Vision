...
// Atmospheric loading fallback component in clean light minimalist aesthetic
const DashboardLoadingSkeleton = () => (
  <div className="flex-1 p-6 md:p-8 space-y-6 animate-pulse">
    ...
    <div className="h-96 bg-white rounded-2xl border border-slate-200 flex items-center justify-center text-slate-500 text-xs shadow-xs">
      ...
      >
        ...
        <header className="h-16 border-b border-slate-200/80 px-4 md:px-8 flex items-center justify-between bg-white/90 backdrop-blur-md sticky top-0 z-20 shadow-2xs">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-sky-50 text-sky-700 border border-sky-200 hidden sm:inline-flex items-center gap-1.5 shadow-2xs">
              <span>🇮🇳</span>
          ...
          <div className="flex items-center gap-3 sm:gap-5 text-xs text-slate-600 font-medium">
            ...
            <div className="hidden lg:flex items-center gap-3 text-slate-500 text-[11px] font-mono">
              <span>Latency: <strong className="text-sky-700 font-semibold">{latency}ms</strong></span>
              <span>•</span>
              <span>Sync: <strong className="text-teal-700 font-semibold">{syncText}</strong></span>
            </div>
          </div>
        </header>
