...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="mt-16 border-t border-slate-800 bg-[#0a0e17]/80 backdrop-blur-md text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-white tracking-wide">Project AeroVision</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">
              National-Scale Geospatial Atmospheric Telemetry & Surface AQI Prediction Platform over India. Ingesting Sentinel-5P TROPOMI, CPCB ground sensors, and ERA5 weather dynamics.
            </p>
          ...
          <div className="space-y-2.5">
            <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Geospatial Intelligence</h4>
          ...
          <div className="space-y-2.5">
            <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Data Providers & Attribution</h4>
            <ul className="space-y-1.5">
              <li>
                <a
            ...
            <ul className="space-y-1.5">
              ...
              <li>
                <button
                  ...
                  className="hover:text-purple-400 transition-colors cursor-pointer text-left flex items-center gap-1"
                >
        ...
        <div className="pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          <p>© {new Date().getFullYear()} Project AeroVision. Atmospheric remote sensing and deep learning telemetry.</p>
          <div className="flex items-center gap-4">
            <span className="text-slate-600">Built for National Environmental Intelligence</span>
            <span>•</span>
            <span className="text-purple-400/80 font-mono">v1.2.0-Production</span>
          </div>
        </div>
      </div>
    </footer>
