...
export const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <div className="flex-1 p-4 md:p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="p-6 md:p-10 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-8 text-slate-700 dark:text-slate-300">
        ...
        <div className="p-4 rounded-2xl bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800/50 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <h2 className="text-sm font-bold text-purple-900 dark:text-purple-200">Your Privacy, Your Control</h2>
        ...
        <div className="space-y-6 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          <section className="space-y-3">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-left border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden mt-2">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800 bg-white dark:bg-slate-900/60">
                  ...
                  <tr>
                    <td className="p-3 font-mono text-purple-700 dark:text-purple-300 font-semibold">_ga / _ga_* (Optional)</td>
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-xs space-y-1 text-slate-700 dark:text-slate-300">
              <p className="font-bold text-slate-950 dark:text-white">Project AeroVision Data Governance Team</p>
              <p>Email: <a href="mailto:privacy@aerovision.in" className="text-purple-600 dark:text-purple-400 font-semibold hover:underline">privacy@aerovision.in</a></p>
